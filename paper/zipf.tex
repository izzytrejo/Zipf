...
\subsection{Pareto's Principle}
 In language, the mostfrequently used 18 percent of words account for 80% of all word occurences. Just like other examples of Zipf's law, Pareto's Principle is seen in many other distributions as well. For example, the richest 20% of humans generate 82.7% of the world's income. Another socioeconomic example is that, in the United States, 20 percent of medical patients use 80% of the country's health care resources. By taking Pareto's law, case by case, it may be possible to figure out what is causing Zipf's law, as the both laws are related to one another. By looking at Pareto's Principle, along with research on Zipf's law, it will be more than possible to find out why Zipf's law ocurrs.
